...
import org.cuieney.videolife.common.utils.ImageUtil;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        Point point = ImageUtil.getGridVerPosterSize(mContext, 4);
        ...
        if (mDataset.get(i).getPoster() != null) {
            ImageUtil.displayImage(viewHolder.mPostImg, mDataset.get(i).getPoster(), point.x, point.y);
        } else {
        }
